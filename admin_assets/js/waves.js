!(function(t) {
  ...
  function a(t) {
    var e,
      ...
      i = { top: 0, left: 0 },
      o = t && t.ownerDocument;
    return (e = o.documentElement), "undefined" !=
      typeof t.getBoundingClientRect && (i = t.getBoundingClientRect()), (a = n(
      o
    )), {
    ...
    c = {
      ...
      show: function(t, e) {
        ...
        "touches" in t &&
          ...
          ), o.setAttribute("data-hold", Date.now()), o.setAttribute(
          "data-scale",
          d
        ), o.setAttribute("data-x", u), o.setAttribute("data-y", s);
        var l = { top: s + "px", left: u + "px" };
        (o.className = o.className + " waves-notransition"), o.setAttribute(
          "style",
          i(l)
        ), (o.className = o.className.replace("waves-notransition", "")), (l[
          "-webkit-transform"
        ] = d), (l["-moz-transform"] = d), (l["-ms-transform"] = d), (l[
          "-o-transform"
        ] = d), (l.transform = d), (l.opacity = "1"), (l[
          "-webkit-transition-duration"
        ] =
          c.duration + "ms"), (l["-moz-transition-duration"] =
          c.duration + "ms"), (l["-o-transition-duration"] =
          c.duration + "ms"), (l["transition-duration"] =
          ...
          "cubic-bezier(0.250, 0.460, 0.450, 0.940)"), o.setAttribute(
          "style",
          i(l)
        );
      },
        ...
        for (var e = 0; e < t.length; e++) {
          ...
          if ("input" === n.tagName.toLowerCase()) {
            ...
            o || (o = ""), i.setAttribute("style", o), (n.className =
              "waves-button-input"), n.removeAttribute("style"), a.replaceChild(
              i,
              n
            ), i.appendChild(n);
          }
  ...
  (s.displayEffect = function(e) {
    (e = e || {}), "duration" in e && (c.duration = e.duration), c.wrapInput(
      u(".waves-effect")
    ), "ontouchstart" in t &&
    ...
    "input" === e.tagName.toLowerCase() &&
      (c.wrapInput([e]), (e = e.parentElement)), "ontouchstart" in t &&
