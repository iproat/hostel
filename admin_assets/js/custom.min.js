  ...
  $(function() {
    ...
    var i = function() {
        ...
        768 > l
          ...
          : $("div.navbar-collapse").removeClass("collapse"), 1170 > l
          ? (
          ...
          : e.removeClass("content-wrapper"), (s -= i), 1 > s && (s = 1), s >
          i && $("#page-wrapper").css("min-height", s + "px");
      },
      l = window.location,
      s = $("ul.nav a")
        .filter(function() {
        ...
        .parent();
    s.is("li") &&
      s.addClass("active"), $(window).ready(i), $(window).bind("resize", i);
  }), (function(e, i, l) {
    ...
    size: "5px",
    color: "#dcdcdc"
  }), $(".slimscrollsidebar").slimScroll({ height: "100%", position: "right", size: "6px", color: "rgba(0,0,0,0.3)" }), $(".chat-list").slimScroll({ height: "100%", position: "right", size: "0px", color: "#dcdcdc" }), e.trigger("resize"), $(
    ".visited li a"
  ).on("click", function(e) {
