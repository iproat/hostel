!(function(t, e) {
  ...
  function i(t) {
    var n,
      ...
      i = t && t.ownerDocument;
    return (n =
      i.documentElement), void 0 !== t.getBoundingClientRect && (a = t.getBoundingClientRect()), (o = e(i)), { top: a.top + o.pageYOffset - n.clientTop, left: a.left + o.pageXOffset - n.clientLeft };
  }
  function r(t) {
    var e = "";
    ...
    if (null !== e) {
      ...
      if ((h.registerEvent(t), "touchstart" === t.type && v.delay)) {
        var n = !1,
          ...
          a = function(a) {
            o && (clearTimeout(o), (o = null), v.show(t, e)), n ||
              ((n = !0), v.hide(a, e)), r();
          },
          i = function(t) {
            o && (clearTimeout(o), (o = null)), a(t), r();
          };
        e.addEventListener("touchmove", i, !1), e.addEventListener(
          "touchend",
          a,
          !1
        ), e.addEventListener("touchcancel", a, !1);
        var r = function() {
          e.removeEventListener("touchmove", i), e.removeEventListener(
            "touchend",
            a
        ...
        v.show(t, e), m &&
          ...
          ), e.addEventListener("mouseup", v.hide, !1), e.addEventListener(
          "mouseleave",
          v.hide,
          !1
        );
  ...
  var l = l || {},
    ...
    v = {
      ...
      show: function(t, e, n) {
        ...
        "touches" in t && t.touches.length
          ...
          : ((s = t.pageY - a.top), (u = t.pageX - a.left)), (u =
          u >= 0 ? u : 0), (s = s >= 0 ? s : 0);
        var c = "scale(" + e.clientWidth / 100 * 3 + ")",
          l = "translate(0,0)";
        n && (l = "translate(" + n.x + "px, " + n.y + "px)"), o.setAttribute(
          "data-hold",
          Date.now()
        ), o.setAttribute("data-x", u), o.setAttribute(
          "data-y",
          s
        ), o.setAttribute("data-scale", c), o.setAttribute("data-translate", l);
        var d = { top: s + "px", left: u + "px" };
        o.classList.add("waves-notransition"), o.setAttribute(
          "style",
          r(d)
        ), o.classList.remove("waves-notransition"), (d["-webkit-transform"] =
          c + " " + l), (d["-moz-transform"] = c + " " + l), (d[
          "-ms-transform"
        ] =
          c + " " + l), (d["-o-transform"] = c + " " + l), (d.transform =
          c + " " + l), (d.opacity = "1");
        var f = "mousemove" === t.type ? 2500 : v.duration;
        (d["-webkit-transition-duration"] = f + "ms"), (d[
          "-moz-transition-duration"
        ] =
          f + "ms"), (d["-o-transition-duration"] = f + "ms"), (d[
          "transition-duration"
        ] =
          f + "ms"), o.setAttribute("style", r(d));
      },
      hide: function(t, e) {
        for (
        ...
        m &&
          ...
          ), e.removeEventListener("mouseup", v.hide), e.removeEventListener(
          "mouseleave",
          v.hide
        );
      }
    ...
    p = {
      input: function(t) {
        ...
        if (
          ...
          (n.className = t.className + " waves-input-wrapper"), (t.className =
            "waves-button-input"), e.replaceChild(n, t), n.appendChild(t);
    ...
    h = {
      ...
      allowEvent: function(t) {
        var e = !0;
        return /^(mousedown|mousemove)$/.test(t.type) &&
          h.touches &&
          (e = !1), e;
      },
  ...
  return (l.init = function(t) {
    var e = document.body;
    "duration" in (t = t || {}) && (v.duration = t.duration), "delay" in t &&
      (v.delay = t.delay), m &&
      (
    ...
    (t = a(t)), "[object Array]" === f.call(e) && (e = e.join(" ")), (e = e
      ? " " + e
      : "");
    for (var n, o, i = 0, r = t.length; i < r; i++)
      (o = (n = t[i]).tagName.toLowerCase()), -1 !==
        ["input", "img"].indexOf(o) && (p[o](n), (n = n.parentElement)), -1 ===
