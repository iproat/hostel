...
//         (68, 0, NULL, 'OT Report', 'dailyOverTime.dailyOverTime', 12, 1)");
...
// (31, 0, NULL, 'Generate Salary Sheet', 'generateSalarySheet.index', 6, 1),
// (32, 25, NULL, 'Late Configration', 'salaryDeductionRule.index', 6, 1),
// (33, 0, NULL, 'Report', NULL, 6, 1),
// (34, 33, NULL, 'Payment History', 'paymentHistory.paymentHistory', 6, 1),
// (35, 33, NULL, 'My Payroll', 'myPayroll.myPayroll', 6, 1),
// (36, 0, NULL, 'Performance Category', 'performanceCategory.index', 7, 1),
// (37, 0, NULL, 'Performance Criteria', 'performanceCriteria.index', 7, 1),
// (38, 0, NULL, 'Employee Performance', 'employeePerformance.index', 7, 1),
// (39, 0, NULL, 'Report', NULL, 7, 1),
// (40, 39, NULL, 'Summary Report', 'performanceSummaryReport.performanceSummaryReport', 7, 1),
// (41, 0, NULL, 'Job Post', 'jobPost.index', 8, 1),
// (42, 0, NULL, 'Job Candidate', 'jobCandidate.index', 8, 1),
// (43, 20, NULL, 'My Attendance Report', 'myAttendanceReport.myAttendanceReport', 4, 1),
// (44, 10, NULL, 'Earn Leave Configure', 'earnLeaveConfigure.index', 3, 1),
// (45, 0, NULL, 'Training Type', 'trainingType.index', 9, 1),
// (46, 0, NULL, 'Training List', 'trainingInfo.index', 9, 1),
// (47, 0, NULL, 'Training Report', 'employeeTrainingReport.employeeTrainingReport', 9, 1),
// (48, 0, NULL, 'Award', 'award.index', 10, 1),
// (49, 0, NULL, 'Notice', 'notice.index', 11, 1),
// (50, 0, NULL, 'Settings', 'generalSettings.index', 12, 1),
// (51, 0, NULL, 'Manual Attendance', 'manualAttendance.manualAttendance', 4, 1),
// (52, 22, NULL, 'Summary Report', 'summaryReport.summaryReport', 3, 1),
// (53, 22, NULL, 'My Leave Report', 'myLeaveReport.myLeaveReport', 3, 1),
// (54, 0, NULL, 'Warning', 'warning.index', 2, 1),
...
// (56, 0, NULL, 'Promotion', 'promotion.index', 2, 1),
// (57, 20, NULL, 'Summary Report', 'attendanceSummaryReport.attendanceSummaryReport', 4, 1),
// (58, 0, NULL, 'Manage Work Hour', NULL, 6, 1),
// (59, 58, NULL, 'Approve Work Hour', 'workHourApproval.create', 6, 1),
// (60, 0, NULL, 'Employee Permanent', 'permanent.index', 2, 1),
// (61, 0, NULL, 'Manage Bonus', NULL, 6, 1),
// (62, 61, NULL, 'Bonus Setting', 'bonusSetting.index', 6, 1),
// (63, 61, NULL, 'Generate Bonus', 'generateBonus.index', 6, 1),
// (64, 18, NULL, 'Dashboard Attendance', 'attendance.dashboard', 4, 1),
// (65, 0, NULL, 'Front Setting', NULL, 12, 1),
// (66, 65, NULL, 'General Setting', 'front.setting', 12, 1),
// (67, 65, NULL, 'Front Service', 'service.index', 12, 1),
// -- (68, 0, NULL, 'Report', 5, 1),
// (68, 0, NULL, 'Daily OT Report', 'dailyOverTime.dailyOverTime', 5, 1),
// (69, 0, NULL, 'Monthly OT Report', 'monthlyOverTime.monthlyOverTime', 5, 1),
// (70, 0, NULL, 'My OT Report', 'myOverTimeReport.myOverTimeReport', 5, 1)");
