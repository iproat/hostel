...
<body>
    ...
    <section id="wrapper" class="new-login-register" style="">
        <div class="container">
            <div class="row">
                    ...
                    <div class="white-box" style="background: #27333e">
                        ...
                        <div class="login-logo" style="text-align: center">
                            <a href="{{ Url('/') }}"><img src="{!! asset('admin_assets/img/logo.png') !!}"
                                    style="margin-top: 12px; width: 90%;background: #27333e;
                                    height: 120px;object-fit: cover;" /></a>
                        </div>
                        ...
                        <div class="form-group  m-t-8">
                            <div class="col-xs-12">
                                <label class="color-white">User Name</label>
