				...
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
						...
						@if(count($results) > 0)
							<h4 class="text-right">
								@if(isset($from_date))
									<a class="btn btn-success" style="color: #fff" href="{{ URL('downloadMyPaidLeaveReport/?employee_id='.session('logged_session_data.employee_id').'&from_date='.$from_date.'&to_date='.$to_date)}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> @lang('common.download') PDF</a>
								@else
									<a class="btn btn-success" style="color: #fff" href="{{ URL('downloadMyPaidLeaveReport/?employee_id='.session('logged_session_data.employee_id').'&from_date='.dateConvertDBtoForm(date('Y-01-01')) .'&to_date='.dateConvertDBtoForm(date('Y-m-d')) )}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i>  @lang('common.download') PDF</a>
								@endif
							</h4>
						@endif
                        @if(!empty($results))
