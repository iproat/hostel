							...
							<div class="row">
								<div class="col-md-4">
									...
									<div class="input-group">
										...
										{!! Form::text('application_from_date', Input::old('application_from_date'), $attributes = ['class' => 'form-control application_from_date','disabled' => 'true', 'readonly' => 'readonly', 'placeholder' => __('common.from_date')]) !!}
									</div>
								</div>
								<div class="col-md-4">
...
<script>
	jQuery(function() {
	$('body').find('.application_from_date').attr('disabled', true);
	$('body').find('.application_to_date').attr('disabled', true);
		...
		$(document).on("change", ".employee_id", function() { 
			...
			$('body').find('.application_from_date').attr('disabled', false);
			$('body').find('.application_to_date').attr('disabled', false);
		...
		$(document).on("change", ".leave_type_id", function() {
			...
			if (employee_id != '' && leave_type_id != '') {
				...
				$.toast({
					heading: 'Warning',
					text: 'Please select Name of the employee !',
					position: 'top-right',
					loaderBg: '#ff6849',
					icon: 'warning',
					hideAfter: 3000,
