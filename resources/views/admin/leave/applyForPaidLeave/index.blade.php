...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				<a href="{{ route('applyForPaidLeave.create') }}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> @lang('leave.apply_for_leave')</a>
			</div>
    </div>
