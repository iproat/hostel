                                        ...
                                        @foreach ($results as $value)
                                            <tr>
                                                ...
                                                @elseif($value->status == 2)
                                                    <td style="width: 100px;">
                                                        <span
                                                            class="label label-success">@lang('common.approved')</span>
                                                    </td>
                                                @else
                                                    <td style="width: 100px;">
                                                ...
                                                <td>
                                                    @if ($value->status == 1)
                                                        <a href="{!! route('requestedPaidLeaveApplication.viewDetails', $value->paid_leave_application_id) !!}"
                                                            title="View Paid leave details!"
