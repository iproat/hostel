...
@section('content')
@section('title')
    @lang('employee.bonus_day_calculation') - @lang('employee.employee_eligible')
@endsection
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li> @lang('employee.employee_eligible')</li>
            </ol>
        </div>
    </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div id="custom-search-input">
                                        <label class="control-label"
                                            for="exampleInput">@lang('common.employee_name')</label>
                                        <div class="input-group col-md-12">
                                            <input type="text" class="search-query form-control employee_name"
                                                placeholder=" @lang('employee.search_by_employee_name')" />
                        ...
                        <br>
                        <div class="data">
                            @include('admin.payroll.bonusday.pagination')
                        </div>
                    </div>
                </div>
            </div>
