							...
							<div class="">
								...
								<div class="education_qualification">
									<section class="content">
										<div class="row">
											<div class="col-xs-12">
												<div class="panel-custom">
													<h3 class="panel-title"><i class="fa fa-laptop"></i> Document1 Information</h3>
												</div>
												<div class="box">
													<div class="box-body">
														<table id="example1" class="table table-bordered table-hover">
															...
															<tbody class="education_lable">
																		...
																		<tr>
																			...
																			<td><a href="{{asset('/uploads/employeeDocuments/')}}/{{$employeeInfo->document_name}}" download>Download File
								...
								<div class="education_qualification">
									<section class="content">
										<div class="row">
											<div class="col-xs-12">
												<div class="panel-custom">
													<h3 class="panel-title"><i class="fa fa-laptop"></i> Document 2 Information</h3>
												</div>
												<div class="box">
													<div class="box-body">
														<table id="example1" class="table table-bordered table-hover">
															...
															<tbody class="education_lable">
																		...
																		<tr>
																			...
																			<td><a href="{{asset('/uploads/employeeDocuments/')}}/{{$employeeInfo->document_name2}}" download>Download File
								...
								<div class="education_qualification">
									<section class="content">
										<div class="row">
											<div class="col-xs-12">
												<div class="panel-custom">
													<h3 class="panel-title"><i class="fa fa-laptop"></i> Document 3 Information</h3>
												</div>
												<div class="box">
													<div class="box-body">
														<table id="example1" class="table table-bordered table-hover">
															...
															<tbody class="education_lable">
																		...
																		<tr>
																			...
																			<td><a href="{{asset('/uploads/employeeDocuments/')}}/{{$employeeInfo->document_name3}}" download>Download File
								...
								<div class="education_qualification">
									<section class="content">
										<div class="row">
											<div class="col-xs-12">
												<div class="panel-custom">
													<h3 class="panel-title"><i class="fa fa-laptop"></i> Document 4 Information</h3>
												</div>
												<div class="box">
													<div class="box-body">
														<table id="example1" class="table table-bordered table-hover">
															...
															<tbody class="education_lable">
																		...
																		<tr>
																			...
																			<td><a href="{{asset('/uploads/employeeDocuments/')}}/{{$employeeInfo->document_name4}}" download>Download File
								...
								<div class="education_qualification">
									<section class="content">
										<div class="row">
											<div class="col-xs-12">
												<div class="panel-custom">
													<h3 class="panel-title"><i class="fa fa-laptop"></i> Document 5 Information</h3>
												</div>
												<div class="box">
													<div class="box-body">
														<table id="example1" class="table table-bordered table-hover">
															...
															<tbody class="education_lable">
																		...
																		<tr>
																			...
																			<td><a href="{{asset('/uploads/employeeDocuments/')}}/{{$employeeInfo->document_name5}}" download>Download File
								...
								<div class="personal_info">
									<div class="row">
										<div class="col-xs-12">
											<div class="panel-custom">
												<h3 class="panel-title"><i class="fa fa-info-circle"></i> @lang('employee.conntected_device')</h3>
											</div>
										</div>
									</div>
									<div class="row">
