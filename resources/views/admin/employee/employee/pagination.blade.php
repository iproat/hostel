            ...
            <tbody>
                ...
                <tr class="{!! $value->employee_id !!}">
                    ...
                    <td>
                        ...
                        <a href="{!! route('employee.show', $value->employee_id) !!}"><img style=" width: 70px; "
                                src="{!! asset('uploads/employeePhoto/' . $value->photo) !!}" alt="user-img"
                                class="img-circle"></a>
                        @else
                        <a href="{!! route('employee.show', $value->employee_id) !!}"> <img style=" width: 70px; "
                    ...
                    <td>
                        ...
                        <span class="font-medium">
                            ...
                            <a href="{!! route('employee.show', $value->employee_id) !!}">{!! $value->first_name
                                !!}&nbsp;{!! $value->last_name !!}</a>
                        ...
                        <br /><span class="text-muted">
                            ...
                            @lang('employee.supervisor') : {!! $value->supervisor->first_name !!} {!!
                    ...
                    <!-- <td>
                        ...
                        <span class="font-medium">
                            ...
                            {!! $value->payGrade->pay_grade_name !!} <span
                                class="bdColor">(@lang('employee.monthly'))</span>
                            @endif

                            @if (isset($value->hourlySalaries->hourly_grade))
                            {!! $value->hourlySalaries->hourly_grade !!} <span
                                class="bdColor">(@lang('employee.hourly'))</span>
                            @endif
                    ...
                    <td style="width: 150px">
                        ...
                        <a title="Profile" href="{!! route('employee.show', $value->employee_id) !!}"
                        ...
                        <?php if($value->employee_id !=1) { ?>
                        <a href="{!! route('employee.edit', $value->employee_id) !!}"
                        ...
                        <a href="{!! route('employee.delete', $value->employee_id) !!}" data-token="{!! csrf_token() !!}"
                            data-id="{!! $value->employee_id !!}" class="delete btn btn-danger btn-xs deleteBtn btnColor"><i
