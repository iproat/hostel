 ...
 @section('content')
 @section('title')
     @lang('overtime.monthly_overtime_report')
 @endsection
 <style>
     .employeeName {
         position: relative;
         ...
         <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
             <ol class="breadcrumb">
                 <li class="active breadcrumbColor"><a href="{{ url('dashboard') }}"><i class="fa fa-home"></i>
                         @lang('overtime.monthly_overtime')</a></li>
                 <li>@yield('title')</li>
             </ol>
         </div>
             ...
             <div class="panel panel-info">
                 ...
                 <div class="panel-wrapper collapse in" aria-expanded="true">
                     <div class="panel-body">
                         <div class="row">
                             <div id="searchBox">
                                 {{ Form::open(['route' => 'monthlyOverTime.monthlyOverTime', 'id' => 'monthlyOverTime']) }}
                         ...
                         @if (count($results) > 0 && $results != '')
                             <h4 class="text-right">
                                 <a class="btn btn-success" style="color: #fff"
                                     href="{{ URL('downloadMonthlyOverTime/?employee_id=' . $employee_id . '&from_date=' . $from_date . '&to_date=' . $to_date) }}"><i
                                         ...
                                         @if (count($results) > 0 && $total_working_hour > $value['working_time'])
                                             ...
                                             <tr>
                                                 ...
                                                 <td style="background: #eee">
                                                     <b>@lang('overtime.expected_working_hour'): &nbsp;</b>
                                                 </td>
                                                 <td style="background: #eee">
                                                     @php
                                                        //  $daily_timing = date('H:i', strtotime($value['workingHour']));
                                                        //  $daily_hour_minit = explode(':', $daily_timing);
                                                        //  $dailyTotalHour = $daily_hour_minit[0] * 60;
                                                        //  $dailyTotalMinit = $daily_hour_minit[1];
                                                        //  $addDailyMin = $dailyTotalHour + $dailyTotalMinit;
                                                        //  $total_daily_time = $addDailyMin / 60;
                                                        //  $total_daily_Hour = floor($addDailyMin / 60);
                                                        //  $total_daily_Minit = ($total_daily_time - $total_daily_Hour) * 60;
                                                        //  $total_daily_workHour = sprintf('%02d', $total_daily_Hour) . '.' . sprintf('%02d', $total_daily_Minit);
                                             ...
                                             <tr>
                                                 <td colspan="4"></td>
                                                 <td style="background: #eee">
                                                     <b>@lang('overtime.actual_working_hour'):
                                                         &nbsp;</b>
                                                 </td>
                                                 <td style="background: #eee">
                                                     <b>{{ $total_workHour }}</b>
