                                    ...
                                    @if (count($results) > 0 && $total_working_hour > $value['working_time'])
                                        ...
                                        <tr>
                                            ...
                                            <td style="background: #eee">
                                                @php
                                                    $actual_time = $totalPresent * 8.5 * $serial;
                                                @endphp
                                                <b>{{ $expected = round($actual_time) }}</b>
                                                @lang('common.hours')
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background: #eee"><b>@lang('overtime.actual_working_hour'):
                                                    &nbsp;</b></td>
                                            <td style="background: #eee"><b>{{ round($total_working_hour) }}</b>
                                                @lang('common.hours')</td>
                                        </tr>

                                        <?php
                                        $overtime = $total_working_hour - $actual_time;
                                        ?>
                                        <tr>
                                            <td colspan="5"></td>
