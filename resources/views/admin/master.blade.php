...
<head>
    ...
    {{-- <link href="httpdas://cdn.tatables.net/buttons/1.2.2/css/buttons.dataTables.min.css" rel="stylesheet"
        type="text/css" /> --}}
    <!-- Date Picker -->
...
<body class="fix-header" onload="addMenuClass()">
    ...
    <div id="wrapper">
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="{{ url('dashboard') }}">
                        <!-- Logo icon image, you can use font-icon also --><b>
                            <!--This is dark logo icon--><img style="width: 200px; height: 60px; object-fit: cover " src="{{ url('admin_assets/img/logo.png') }}" alt="home" class="" />
                        </b>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        ?>
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{!! asset('uploads/employeePhoto/' . $employeeInfo[0]->photo) !!}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs " style="color: #fff !important;padding-right: 4px"><span class="text-capitalize">{!! $employeeInfo[0]->user_name !!}</span></b><span class="caret"></span>
                            </a>
                        <?php  } else { ?>
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="{!! asset('admin_assets/img/default.png') !!}" alt="user-img" width="36" class="img-circle"><b class="hidden-xs" style="color: #fff !important; "><span class="hideMenu" style="color: #fff !important;">{!! $employeeInfo[0]->user_name !!}</span></b><span class="caret hideMenu"></span> </a>
                        <?php } ?>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li><a href="{{ url('dashboard') }}" class="waves-effect waves-ripple"><i class="mdi mdi-home hideMenu" data-icon="v"></i> <span class="hide-menu hideMenu"> {{ __('menu.dashboard') }}
                            </span></a>
                    </li>
                    <?php
                    $sideMenu = showMenu();
        ...
        {{ date('Y') }} &copy; <strong>
            <a href="https://codecanyon.net/user/bd-webtricks" target="_blank">BD-Webtricks</a>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data == 'hasForeignKey') {
                                    ...
                                    swal({
                                        title: "Oops!",
                                        text: "Following device are offline[ '" + formsg[1] + "' ]. So you cannot delete this employee",
                                        type: "error"
                                    });
                                } else {
                                    swal({
