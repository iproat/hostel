	...
	<div class="row bg-title">
		<div class="col-lg-5 col-md-4 col-sm-4 col-xs-12">
		   <ol class="breadcrumb">
				...
				<li>Expired Office Management Details</li>
			</ol>
		</div>	
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-info">
				<div class="panel-heading"><i class="mdi mdi-table fa-fw"></i> Expired Office Management Details</div>
