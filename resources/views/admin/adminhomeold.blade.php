                ...
                <div class="white-box analytics-info">
                    ...
                    <ul class="list-inline two-part">
                        ...
                        <li class="text-right"><a href="#"><i id="absentDetail"
                                    class="ti-arrow-down text-danger"></i></a> <span
            ...
            <div class="white-box">
                ...
                <div class="row inline-block">
                    ...
                    <div class="col-sm-6" style="position:relative;left:30px;">
                        ...
                        <select name="branch_id" class="form-control branch_id select2" style="width:70%;" required
                            onchange="this.form.submit()">
                            <option value="">--- @lang('employee.select_branch') ---</option>
                            @foreach ($branchList as $value)
                                @if (isset($_POST['branch_id']))
                                    <option value="{{ $value->branch_id }}"
                                        @if ($value->branch_id == $_POST['branch_id']) {{ 'selected' }} @endif>
                                        {{ $value->branch_name }}
                                    </option>
                                @else
                                    <option value="{{ $value->branch_id }}">
                                            ...
                                            @if ($dailyAttendance->branch_id == $_POST['branch_id'])
                                                <tr class="{!! $dailyAttendance->employee_id !!}">
                                                    ...
                                                    <td style="width:20%;">
                                                        ...
                                                        <br /><span
                                                            class="text-muted">{{ $dailyAttendance->branch_name }}</span>
                                                        <br /><span
                                                            class="text-muted">ID:{{ $dailyAttendance->finger_id }}</span>
                                                    </td>
                                                    <td style="width:15%;">
                                                        <?php
